...
\begin{figure}[htpb]
\centering 
\includegraphics[width=1.5\textwidth]{./imgs/MonoSLAM-AoN.png}
...
% \begin{figure}[htpb]
% \centering 
% \includegraphics[height=.85\textheight]{./imgs/Gantt_v1.png}
...
\begin{figure}[htpb]
\centering 
\includegraphics[height=.77\textheight]{./imgs/Gantt_v2.png}
